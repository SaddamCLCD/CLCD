<%-- 
    Document   : about us
    Created on : Jul 8, 2017, 10:45:07 PM
    Author     : SamK
--%>
...
<section class="why_choose_us section-padding gray-bg">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6">
        <div class="video_box">
          <iframe class="mfp-iframe" src="https://www.youtube.com/embed/rqSoXtKMU3Q" allowfullscreen></iframe>https://youtu.be/8XkPaX_A4aY
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
          ...
          <ul>
              ...
              <a href="comingsoon.jsp"><li>Coming Soon</li></a>

...
<%-- 
    Document   : dealers-profile
    Created on : Jul 8, 2017, 10:37:42 PM
    Author     : SamK
--%>
	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	   ...
	   <div class="carousel-inner">
    	  ...
    	  <div class="item active">
              <img src="image/t.jpg" alt="image" style="width: 100%">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-3 col-xs-4">
          <div class="dealer_logo"> <img src="images/Land-Rover-logo.png" alt="image"> </div>
      </div>
      <div class="col-md-6 col-sm-5 col-xs-8">
        <div class="dealer_info">
          <h4>Land Rover Used Cars Center</h4>
          <p>p-4,mohan state<br>
           Mathura Road,New Dehli,Ph-011-333278782</p>
	  ...
	  <aside class="col-md-3">
        <div class="sidebar_widget">
          ...
          <form action="fdcont.jsp">
            ...
            <div class="form-group">
              <textarea rows="4" class="form-control" placeholder="Message" name="dmsg" maxlength="100" onchange="handleChange(this);" required></textarea>
            </div>
            <div class="form-group">

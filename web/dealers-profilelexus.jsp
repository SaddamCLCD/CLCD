<%-- 
    Document   : dealers-profilelexus
    Created on : Jul 10, 2017, 7:03:37 PM
    Author     : SamK
--%>
	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	   ...
	   <div class="carousel-inner">
    	  ...
    	  <div class="item active">
              <img src="image/im.jpg" alt="image" style="width: 100%">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-3 col-xs-4">
          <div class="dealer_logo"> <img src="image/inspection.png" alt="image"> </div>
      </div>
      <div class="col-md-6 col-sm-5 col-xs-8">
        <div class="dealer_info">
            <h4>Lexus Services center</h4>
